...
function myKeyDown(e)
{
	...
	function up()
	{
		...
		console.log("cima for pressionada, X =  " + ball_X + " , Y = "+ball_Y);
		canvas.remove(ball_obj);
		new_image();
		}
	}
	...
	function down()
	{
		...
		console.log("baixo for pressionado, X =  " + ball_X + " , Y = "+ball_Y);
		canvas.remove(ball_obj);
		new_image();
		 }
	}
	...
	function left()
	{
		...
		console.log("esquerda for pressionado, X =  " + ball_X + " , Y = "+ball_Y);
		canvas.remove(ball_obj);
		new_image();
	}
}
	...
	function right()
	{
		...
		console.log("direta for pressionada, X =  " + ball_X + " , Y = "+ball_Y);
		canvas.remove(ball_obj);
		new_image();
	}
}
